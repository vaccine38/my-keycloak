...
public class BookController {
	...
	public ResponseEntity<String> list(@RequestBody BookListRequest request) {
		return ResponseEntity.ok("list book with name keyword " + request.getNameKeyword());
	}
	...
	public ResponseEntity<String> metadata() {
		return ResponseEntity.ok("Some metadata of Books");
	}
	
	@PutMapping
	public ResponseEntity<String> update(@RequestBody BookUpdateRequest request) {
		return ResponseEntity.ok("Update book with id " + request.getId() + " updated");
	}
	
	@PostMapping
	public ResponseEntity<String> create(@RequestBody BookCreateRequest request) {
		return ResponseEntity.ok("Create new book with name " + request.getName());
	}
